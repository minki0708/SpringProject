...
/*     function test(res) {
	...
	let datepicker2 = 0;
    let calDate = 0; 
    <c:set var="period" value="${period1}"/>
	function date(){
 ...
 /*    	 if(datepicker1 || datepicker2 == ""){
         ...
         if(${period} == 365){
	         data.addRows([
		        <c:forEach var="d" begin="0" end="${calDate}" step="${period}" varStatus="st">
		            [${d},  37.8, 80.8, 41.8],
        	  ...
        	  data.addRows([
      	        <c:forEach var="m" begin="0" end="${calDate}" step="${period}" varStatus="st2">
      	            [${m},  37.8, 80.8, 41.8],
      	            <c:set var="end2" value="${st2.end}"/>
      	 		</c:forEach>     
              	[${end2},  30,  6.2,  3.4]
              ]);
         }
        	 ...
        	 data.addRows([
       	        <c:forEach var="y" begin="0" end="30" step="${period}" varStatus="st3">
       	            [${y},  37.8, 80.8, 41.8],
       	            <c:set var="end3" value="${st3.end}"/>
       	 		</c:forEach>     
               	[${end3},  1,  6.2,  3.4]
               ]);
         } 
