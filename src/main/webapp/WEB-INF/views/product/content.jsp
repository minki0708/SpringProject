...
<body>
	...
	<div class="w3-container" style="width: 100%;max-height: 7000px;margin-top: 300px">
		<div class="w3-container" style="width: 1400px;margin: auto">
			<div class="w3-row">
				<div class="w3-col m6 w3-center" style="margin-bottom: 7em">
					<c:set var="fSNames" value="${fn:split(vo.FSName,'/')}"/>
			  		  	<div class="slider" style="height:30em; width:30em;margin: auto">
...
<%-- 						<c:set var="fSNameLen" value="${fn:length(fSName)}"/>
					  	...
					  	<c:if test="${extUpper=='JPG--' || extUpper=='GIF' || extUpper=='PNG'}">	 --%>
				           	<div class="img-box" style="height:30em; width:30em;">
				           		<img src="${ctp}/pds/${fSName}" style="height:30em; width:30em"/>
				           	</div>					           		
			  			<%-- </c:if> --%>
	 					</c:forEach> 
			  		  	</div>
				...
				<div class="w3-col m6">
					<h2><b>${vo.title}</b></h2><br>
					<h1 style="text-align: left"><b><fmt:formatNumber value="${vo.price}" pattern="#,###"/>원</b></h1>
					<hr>
					<div class="w3-container" style="margin-bottom: 50px">
						<div class="w3-left w3-margin-right"><h5><font color="gray"><i class="fa fa-heart-o" aria-hidden="true"></i> ${likes}</font></h5></div>
						<div class="w3-left w3-margin-right"><h5><font color="gray"><i class="fa fa-eye" aria-hidden="true"></i>${vo.readCount}</font></h5></div>
						<div class="w3-left w3-margin-right"><h5><font color="gray"><i class="fa fa-clock-o" aria-hidden="true"></i> ${vo.strdate}</font></h5></div>
					</div>
					
					<div class="w3-row" style="margin-bottom: 0.5em">
						<div class="w3-col m2"><font color="gray">상품상태</font></div>
						<div class="w3-col m10">${vo.state }</div>
					</div>
					<div class="w3-row" style="margin-bottom: 0.5em">
						<div class="w3-col m2"><font color="gray">교환여부</font></div>
						<div class="w3-col m10">${vo.exchange }</div>
					</div>
					<div class="w3-row" style="margin-bottom: 0.5em">
						<div class="w3-col m2"><font color="gray">거래지역</font></div>
						<c:set var="adr" value="${fn:split(vo.address,'/')}"/>
						<div class="w3-col m10"><i class="fa fa-map-marker" aria-hidden="true"></i> ${adr[1]}</div>
					</div>
					<div class="w3-container" style="margin-top: 50px">
						<%-- <a id="like" href="javascript:likeCheck('${vo.idx}','${sIdx}')">❤</a>(${likes}) --%>
						<a href="javascript:likeCheck('${vo.idx}','${sIdx}')" class="w3-button  w3-ripple w3-light-gray" style="width: 200px;height: 50px;padding-top: 10px">
							<font size="2px"><i class="fa fa-heart" aria-hidden="true"></i> 좋아요</font>
						</a>
						<a href="javascript:buy('${vo.idx}','${sIdx}')" class="w3-button  w3-ripple w3-light-gray" style="width: 200px;height: 50px;padding-top: 10px">
							<font size="2px">구매하기</font>
						</a>
						<c:if test="${vo.userIdx == sIdx}">
						<a href="${ctp}/product/update?idx=${vo.idx}" class="w3-button  w3-ripple w3-light-gray" style="width: 200px;height: 50px;padding-top: 10px">
							<font size="2px">수정하기</font>
						</a>
						</c:if>
						<a class="w3-button w3-ripple w3-light-gray" onclick="productModal('${vo.idx}','${sIdx}','${vo.userIdx}')" style="width: 200px;height: 50px;padding-top: 10px"><font size="2px">신고하기</font></a>			      
			...
			<div class="w3-row">
				<div class="w3-col m8 w3-border-right" style="padding-right: 1em">
					<br>
					<h5>상품 정보</h5>
					<hr>
					<div class="w3-container">
					...
					<div class="w3-container">
						<div class="w3-third">
						<p style="text-align: center;color:gray"><i class="fa fa-map-marker" aria-hidden="true"></i> 거래지역</p>
						<p style="text-align: center">${adr[1]} </p>
						</div>
						<div class="w3-third">
						<p style="text-align: center;color:gray">카테고리</p>
						<p style="text-align: center">카테고리자리</p>
						</div>
						<div class="w3-third">
						<p style="text-align: center;color:gray">판매 개시일</p>
						<p style="text-align: center">${vo.date}</p>
						</div>
					</div>
					<hr>
					<div id="reply">
		...
		<table class="table text-center">
		  <tr>
		    ...
		    <td style="width:15%">
				...
				<div class="w3-col m4" style="padding-left: 1em">
					<br>
					<h5>상점 정보</h5>
					<hr>
					<div class="w3-row">
						<div class="w3-col m2">
						<img src="${ctp}/images/shop.svg" style="width: 4em">
						</div>
						<div class="w3-col m10">
							<div class="w3-row">
								<div class="w3-col m12 w3-margin-bottom">${userVo.nickName}</div>
								<div class="w3-col m2 w3-border-right"><font color="gray">상품 0</font> </div>
								<div class="w3-col m4" style="padding-left: 10px"><font color="gray">팔로워 0</font></div>
							</div>
						</div>
					</div>
					<!-- 상점 정보나 추가 상품보여주려면 여기 -->
					<hr>
				</div>
			</div>
		</div>
